...
<body>
    <section>
        <footer class="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 mt-6 py-14 px-16 font-sans tracking-wide relative">
            ...
            <div class="flex sm:justify-between flex-wrap gap-6">
                <div class="flex space-x-5">
                    <a href="javascript:void(0)" class="text-gray-300 hover:text-white text-sm transition-all">
                ...
                <p class='text-gray-300 text-sm'>© Developed by Adib Mahmud. All rights reserved.
                </p>
            </div>
        </footer>
    </section>
